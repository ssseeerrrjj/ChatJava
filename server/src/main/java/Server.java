...
public class Server {
    ...
    public void sendPrivateMessage(ClientHandler clientHandler, String message, String nickname) {
        if (clientHandler.getNickname().equalsIgnoreCase(nickname)) {
            clientHandler.sendMessage("Нельзя отправить приватное сообщение самому себе.");
            return;
        }
        ...
        clientHandler.sendMessage("Пользователь " +
                nickname + " не найден онлайн. Сообщение не отправлено.");
    }
